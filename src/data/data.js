const basicSyntax = {
  ...
  examples: [
    ...
    },
    {
      ...
      examp2: 'Example 2:',
      markdown2: "I just love __bold text__.",
      html2: "I just love <strong>bold text</strong>."
    },
    {
      name: "Code",
        ...
        },
    {
      ...
      examp2: 'Example 2:',
      markdown2: "## Heading level 2",
      html2: "<h2>Heading level 2</h2>",
      examp3: 'Example 3:',
      markdown3: "### Heading level 3",
      html3: "<h3>Heading level 3</h3>",
      examp4: 'Example 4:',
      markdown4: "#### Heading level 4",
      html4: "<h4>Heading level 4</h4>",
      examp5: 'Example 5:',
      markdown5: "##### Heading level 5",
      html5: "<h5>Heading level 5</h5>",
      examp6: 'Example 6:',
      markdown6:"###### Heading level 6",
      html6: "<h6>Heading level 6</h6>",
    },
    {
    ...
    },
    {
      ...
      examp2: 'Example 2:',
      markdown2: "Italicized text is the _cat's meow_.",
      html2:"Italicized text is the <em>cat's meow</em>.",
      examp3: 'Example 3:',
      markdown3: "A*cat*meow",
      html3: "A<em>cat</em>meow",
    },
    {
      name: "Line Breaks",
    ...
    },
    {
      ...
      examp2: 'Example 2:',
      markdown2: "1. First item\n1. Second item\n1. Third item\n1. Fourth item\n",
      html2:"<ol><li>First item</li><li>Second item</li><li>Third item</li><li>Fourth item</li></ol>",
      examp3: 'Example 3:',
      markdown3: "1. First item\n8. Second item\n3. Third item\n5. Fourth item\n",
      html3: "<ol><li>First item</li><li>Second item</li><li>Third item</li><li>Fourth item</li></ol>",
      examp4: 'Example 4:',
      markdown4: "1. First item\n2. Second item\n3. Third item\n  1. Indented item\n  2. Indented item\n4. Fourth item\n",
      html4: "<ol><li>First item</li><li>Second item</li><li>Third item<ol><li>Indented item</li><li>Indented item</li></ol></li><li>Fourth item</li></ol>",
    },
    {
      name: "Paragraphs",
    ...
    },
    {
      ...
      html2: "<ul><li>First item</li><li>Second item</li><li>Third item</li><li>Fourth item</li></ul>",
      examp3: 'Example 3:',
      markdown3: "+ First item\n* Second item\n- Third item\n+ Fourth item\n",
      html3: "<ul><li>First item</li><li>Second item</li><li>Third item</li><li>Fourth item</li></ul>",
      examp4: 'Example 4:',
      markdown4: "- First item\n- Second item\n- Third item\n    - Indented item\n    - Indented item\n- Fourth item\n",
      html4: "<ul><li>First item</li><li>Second item</li><li>Third item<ul><li>Indented item</li><li>Indented item</li></ul></li><li>Fourth item</li></ul>",
    }
  ]
}
